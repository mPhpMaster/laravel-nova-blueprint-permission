...
namespace Illuminate\Database\Eloquent\Factories {
     ...
     */        class Factory {
         ...
         * @static 
         */        public static function randomOr($or_callback = null, $columns = [])
        {
                        return \Illuminate\Database\Eloquent\Factories\Factory::randomOr($or_callback, $columns);
        }
                    /**
         ...
         * @see \MPhpMaster\LaravelAppHelpers\Providers\HelperProvider::registerMacros()
         * @static 
         */        public static function randomOrCreate($columns = [], $attributes = [])
        {
                        return \Illuminate\Database\Eloquent\Factories\Factory::randomOrCreate($columns, $attributes);
        }
                    /**
         ...
         * @see \MPhpMaster\LaravelAppHelpers\Providers\HelperProvider::registerMacros()
         * @static 
         */        public static function randomOrNew($columns = [], $attributes = [])
        {
                        return \Illuminate\Database\Eloquent\Factories\Factory::randomOrNew($columns, $attributes);
        }
            }
    }
...
namespace Laravel\Nova\Fields {
     ...
     */        class Field {
         ...
         * 
         *
         * @see \Wdelfuego\Nova\DateTime\Fields\DateTime::withDateFormatFunction()
         * @param string $format
         * @static 
         */        public static function withDateFormat($format)
        {
                        return \Laravel\Nova\Fields\Field::withDateFormat($format);
        }
                    /**
         * 
         *
         * @see \Laravel\Nova\NovaApplicationServiceProvider::boot()
         * @param string|bool|null $format
         * @static 
         */        public static function displayWithDateTimeFormat($format = null)
        {
                        return \Laravel\Nova\Fields\Field::displayWithDateTimeFormat($format);
        }
            }
    }
...
namespace  {
             ...
             */            public static function randomOr($or_callback = null, $columns = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::randomOr($or_callback, $columns);
            }
                            /**
             ...
             */            public static function randomOrCreate($columns = [], $attributes = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::randomOrCreate($columns, $attributes);
            }
                            /**
             ...
             */            public static function randomOrNew($columns = [], $attributes = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::randomOrNew($columns, $attributes);
            }
                            /**
             ...
             * @see \MPhpMaster\LaravelAppHelpers\Providers\HelperProvider::registerMacros()
             * @static 
             */            public static function randomOrFactory($columns = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::randomOrFactory($columns);
            }
                            /**
             * Returns first random model, or create new model via factory.
             *
             ...
             * @see \MPhpMaster\LaravelAppHelpers\Providers\HelperProvider::registerMacros()
             * @static 
             */            public static function randomOrCreateFactory($columns = [], $attributes = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::randomOrCreateFactory($columns, $attributes);
            }
                            /**
             * Returns first random model, or make new model via factory.
             *
             ...
             * @see \MPhpMaster\LaravelAppHelpers\Providers\HelperProvider::registerMacros()
             * @static 
             */            public static function randomOrNewFactory($columns = [], $attributes = [])
            {
                                return \Illuminate\Database\Eloquent\Builder::randomOrNewFactory($columns, $attributes);
            }
                            /**
             * Helpers
             *
             * @see \MPhpMaster\LaravelHelpers2\Providers\HelperProvider::boot()
             * @param bool $parse
             * @static 
            ...
            class Model extends \App\Models\Abstracts\Model {}
