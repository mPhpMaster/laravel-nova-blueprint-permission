...
abstract class FieldElement extends Element
{
     ...
     * @return $this
     */
    public function hideWhen($callback = true)
    {
        $this
     ...
     * @return $this
     */
    public function hideWhenCreatingAndUpdating($callback = true)
    {
        return $this->hideWhenCreating($callback)
            ->hideWhenUpdating($callback);
    }
     ...
     * @return $this
     */
    public function showWhen($callback = true)
    {
        $this
     ...
     * @return $this
     */
    public function showOnCreatingAndUpdating($callback = true): static
    {
        return $this->showOnCreating($callback)
            ->showOnUpdating($callback);
    }

    public function showOnCreatingForAdmin(): static
    {
        return $this->showOnCreating(isAnyAdminClosure());
    }

    public function showOnUpdatingForAdmin(): static
    {
        return $this->showOnUpdating(isAnyAdminClosure());
    }

    public function showOnCreatingForNonAdmin(): static
    {
        return $this->showOnCreating(isNotAnyAdminClosure());
    }

    public function showOnUpdatingForNonAdmin(): static
    {
        return $this->showOnUpdating(isNotAnyAdminClosure());
    }

    public function showOnCreatingAndUpdatingForAdmin(): static
    {
        return $this->showOnCreatingAndUpdating(isAnyAdminClosure());
    }

    public function showOnCreatingAndUpdatingForNonAdmin(): static
    {
        return $this->showOnCreatingAndUpdating(isNotAnyAdminClosure());
    }
