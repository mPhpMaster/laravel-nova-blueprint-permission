...
//            return url(route('nova.password.login_id_reset', [
//                'token' => $token,
...
//        });
     ...
     */
    public function sendResetLinkLoginId(Request $request)
    {
        $this->validateLoginId($request);

        // We will send the password reset link to this user. Once we have attempted
        // to send the link, we will examine the response then see the message we
        // need to show to the user. Finally, we'll send out a proper response.
        $response = $this->broker()->sendResetLink(
            $this->loginIdCredentials($request)
        );
     ...
     * @return void
     */
    protected function validateLoginId(Request $request)
    {
        $request->validate(['login_id' => 'required|exists:users,login_id']);
    }
     ...
     * @return array
     */
    protected function loginIdCredentials(Request $request)
    {
        return $request->only('login_id');
    }
}
